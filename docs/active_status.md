...
- 133 automated unit, contract, adversarial, persistence, AI-boundary, concurrency, and two-spine solve tests, plus desktop/mobile browser playthroughs of both mysteries and the card editor.

## Still to build

1. Packaging and distribution verification, including frozen-app content and writable-data paths.
